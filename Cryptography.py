...
def reset():
    ...
    panelB.image = image
    mbox.showinfo("Success", "Image Decrypted to original format!")
...
resetb = Button(window, text="Decrypt",command=reset,font=("Arial", 20), bg = "yellow", fg = "blue", borderwidth=3, relief="raised")
